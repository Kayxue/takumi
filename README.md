...
For newcomers, you can try out Takumi in [playground](https://takumi.kane.tw/playground) without installation. Or check [Quick Start](https://takumi.kane.tw/docs/qiuck-start/) page for usage.
