...
<Callout>
This guide is for people plan to use Takumi in Next.js, if you are looking for WASM bindings, check out [WebAssembly (In Browser)](/docs/integrations/wasm-web) guide instead.
</Callout>
