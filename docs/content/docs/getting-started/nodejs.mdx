...
<Callout>
If you are considering using Takumi in any framework or as an endpoint, check out the [From Next.js ImageResponse](/docs/migration/migrate-from-image-response) guide for usage of the `@takumi-rs/image-response` package.
</Callout>
