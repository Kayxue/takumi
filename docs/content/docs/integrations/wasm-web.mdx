---
title: WebAssembly (In Browser)
description: Integrate Takumi with WebAssembly for client-side image generation.
---

<Callout type="warn">
For server-side rendering, consider using the [Node.js or Bun Integration](/docs/integrations/nodejs) for improved performance and compatibility.
</Callout>
...
We have a dedicated guide for [Cloudflare Workers Setup](/docs/integrations/cloudflare-workers).
