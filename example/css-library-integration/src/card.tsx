...
export function TailwindCard({
  ...
  return (
    <div className="h-[630px] w-[1200px] bg-[#09090b] font-sans flex-row overflow-hidden border border-[#27272a]">
      {/* Left Pane - Content & Typo */}
      <div className="w-[640px] h-full flex-col p-20 justify-between bg-linear-to-b from-[#09090b] to-[#18181b] relative z-10">
        <div className="flex-col">
          <div className="items-center px-4 py-2 w-max shrink-0 rounded-full bg-blue-500/10 border border-blue-500/20">
        ...
        <div className="items-center bg-blue-600 w-max shrink-0 px-8 py-5 rounded-2xl shadow-[0_0_40px_-10px_rgba(37,99,235,0.5)]">
      ...
      <div className="flex-1 h-full bg-[#18181b] flex-col p-16 justify-center border-l border-[#27272a] shadow-[-20px_0_60px_-15px_rgba(0,0,0,0.5)]">
        <div className="flex-col gap-8">
          <div className="bg-[#09090b] p-8 rounded-3xl border border-[#27272a] items-start hover:border-blue-500/50 transition-colors">
            <div className="h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-[#18181b] border border-[#27272a] text-blue-500">
...
export function UnoCard({
  ...
  return (
    <div className="h-[630px] w-[1200px] bg-white font-sans flex-col overflow-hidden relative border border-zinc-200">
      ...
      {/* Top Section */}
      <div className="w-full flex-row px-20 py-16 justify-between items-start relative z-10 shrink-0">
        <div className="flex-col max-w-[640px]">
          <div className="items-center px-4 py-1.5 w-max shrink-0 rounded-full bg-zinc-900 shadow-xl border border-zinc-800">
        ...
        <div className="w-32 h-32 shrink-0 bg-linear-to-tr from-rose-500 via-fuchsia-500 to-indigo-500 rounded-[32px] shadow-2xl rotate-6 flex-col items-center justify-center p-1 border-4 border-white">
          <div className="w-full h-full shrink-0 bg-black/10 rounded-[24px] justify-center items-center">
      ...
      <div className="w-full flex-row gap-8 px-20 pb-16 mt-auto relative z-10 flex-1 items-end">
        <div className="flex-1 bg-white/80 p-8 rounded-[40px] border border-white shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] flex-col justify-end h-[240px]">
          <div className="h-16 w-16 shrink-0 bg-zinc-100 rounded-[20px] items-center justify-center mb-auto border border-zinc-200">
